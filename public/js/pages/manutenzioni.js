      ...
      renderTable({
        columns: [
          ...
          },
          {
            key: "tipo",
            label: "Tipo",
            render: (r) => `<span class="badge badge-info">${r.tipo}</span>`,
          },
          {
            key: "descrizione",
            label: "Descrizione",
            render: (r) => r.descrizione || '<span class="text-dim">—</span>',
          },
          {
            key: "km",
            label: "Km",
        ...
        emptyIcon: "🔧",
        emptyText:
          "Nessun intervento registrato. Aggiungi la prima manutenzione.",
      }),
    );
  }
