...
export async function renderClientiPage(container) {
      ...
      renderTable({
        columns: [
          ...
          },
          {
            key: "email",
            label: "Email",
            render: (r) => r.email || '<span class="text-dim">—</span>',
          },
          {
            key: "telefono",
            label: "Telefono",
            render: (r) => r.telefono || '<span class="text-dim">—</span>',
          },
          {
            key: "indirizzo",
            label: "Indirizzo",
            render: (r) => r.indirizzo || '<span class="text-dim">—</span>',
          },
          {
            key: "azioni",
            label: "",
  ...
  function openClienteForm(existing) {
    openFormModal({
      title: existing
        ? `Modifica ${existing.nome} ${existing.cognome}`
        : "Nuovo Cliente",
