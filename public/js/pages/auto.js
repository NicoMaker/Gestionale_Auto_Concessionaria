      ...
      renderTable({
        columns: [
          ...
          { key: "colore", label: "Colore" },
          {
            key: "km",
            label: "Km",
            render: (r) => (r.km ?? 0).toLocaleString("it-IT"),
          },
          {
            key: "prezzo",
            label: "Prezzo",
          ...
          { key: "stato", label: "Stato", render: (r) => statoBadge(r.stato) },
          {
            ...
            render: (r) =>
              r.cliente_nome
                ? `${r.cliente_nome} ${r.cliente_cognome}`
    ...
    openFormModal({
      ...
      fields: [
        ...
        },
        {
          ...
          type: "number",
          step: "0.01",
          value: existing?.prezzo ?? 0,
        },
        {
          name: "stato",
          label: "Stato",
          type: "select",
          value: existing?.stato || "disponibile",
